...
<body>
	...
	@foreach($visa_type as $key=>$visa)
		@if (($visa['visa_details']) != '[]')
			...
			$visa_image = isset($visaDetail['express_image']) ? $visaDetail['express_image'] : $visaDetail['salary_per_region'];
			@endphp
							...
							<tbody>
								...
								<tr>
									<td style="padding: 0 60px;">
										<p style="margin-bottom: 5px; " class="ft92"><span style="color: #ef434c;">1.</span> {{$visaDetail['program_work']}}</p>
									</td>
								</tr>
								...
								<tr>
									<td style="padding: 0 60px;">
										<p style="margin-bottom: 5px; " class="ft92"><img src="{{ asset('pdf/bullet-icon.png')}}" style="margin-right: 15px; margin-bottom: -3px;">{{$visaDetail['requirements']}}</p>
									</td>
								</tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td style="padding: 0 60px;">
										<img src="{{ asset($visa_image)}}" width="100%">
									</td>
								</tr>
							...
							<tbody>
								...
								<tr>
									<td style="padding: 50px 60px;">
									    <img src="{{ asset($visaDetail['cost_image'])}}" width="100%">
									</td>
								</tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td style="padding: 0 60px;">
										<p style="margin-bottom: 5px; " class="ft92"><img src="{{ asset('pdf/check-icon.png')}}" width="14px" height="auto" style="margin-right: 8px;"> {{$visaDetail['requirements']}}</p>
									</td>
								</tr>
								...
								<tr>
									<td style="padding:0 60px;">
										<img width="680" src="{{ asset($visa_image)}}">
									</td>
								</tr>
