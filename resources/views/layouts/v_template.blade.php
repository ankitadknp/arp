...
<head>
    ...
    <meta charset="utf-8" />
    <!-- <title>Assessment Results Platform</title> -->
    <title>Assessment Results Platform</title>
                        ...
                        <div class="topbar">
                            <div class="topbar-item" onclick="swag_logout()">
                                <div
                                    ...
                                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" id="selectedBrandLabel"></span>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" class="text-dark-75 text-hover-primary">Assessment Results Platform</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
