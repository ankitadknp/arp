    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Legal Representative</h5>
            ...
            <div class="modal-body">
                <form id="form" name="form" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <span>Law Logo <span class="label-title">*</sapn></span><br>
                        <input required type="file" name="law_logo" class="form-control" id="law_logo" ><br>
...
<script>
    ...
    $('document').ready(function () {
        ...
        var table = $('#table').DataTable({
            ...
            ajax: "{{ route('representative.index') }}",
            columns: [{
                    data: 'name',
                    name: 'name'
                },
        ...
        $('#saveBtn').click(function (e) {
            ...
            var law_logo = (typeof $('#law_logo')[0].files[0] != 'undefined') ? $('#law_logo')[0].files[0] : '';
            form_data.append("law_logo", law_logo);
        ...
        $('body').on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{route('representative.store')}}" + '/' + id,
                        success: function (data) {
                            swal_success();
                            table.draw();
                        },
        ...
        $('body').on('click', '.logo_delete', function () {
            var id = $(this).data('id');
            $.ajax({
                data: {id:id},
                url: "{{ route('law_logo_delete') }}",
                type: "POST",
                success: function (data) {
                    if(typeof data.error != 'undefined' && data.error!='' && data.error!=null){
                        swal_errorMsg(data.error);
                        ...
                        Swal.fire({
                            position: 'top-end',
                            icon: 'success',
                            title: 'Law logo was deleted successfully!',
                            showConfirmButton: false,
                            timer: 1000
                        })
                    }
